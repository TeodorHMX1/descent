...
{
    [Header("References")] public Text SceneNameText;
    ...
    public GameObject SkipKeyText;
    public RectTransform LoadingCircle;
    public CanvasGroup LoadingCircleCanvas;
    public CanvasGroup FadeImageCanvas;
    private CanvasGroup BackgroundAlpha;
    private readonly List<Sprite> cacheBackgrounds = new List<Sprite>();
    private TheTipList cacheTips;
    private int CurrentBackground;
    private int CurrentTip;
    private bool isTipFadeOut;
    private CanvasGroup LoadingBarAlpha;
    ...
    public void UpdateLoadProgress(float value, float delayedValue)
    {
        ...
        {
            var percent = (delayedValue * 100).ToString("F0");
    ...
    public void SetupUIForScene(bl_SceneLoaderInfo info)
    {
        ...
        {
            if (m_SceneLoader.ShowDescription)
        ...
        if (ProgressText != null) ProgressText.text = string.Format(m_SceneLoader.LoadingTextFormat, 0);
