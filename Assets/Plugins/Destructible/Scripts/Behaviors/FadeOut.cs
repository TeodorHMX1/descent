...
namespace Destructible
{
	...
	{
		[Range(0f, 30f)] public float afterSeconds = 6f; // seconds to wait before starting the fade.
	...
	public static class ShaderExtensions
	{
		public static Shader GetTransparentVersion(this Shader currentShader)
		{
			...
			Debug.LogError(
				"Destructible: No progressive damage transparency shader could be found. Cannot fade out material with shader \"" +
				currentShader.name + "\" object.");
