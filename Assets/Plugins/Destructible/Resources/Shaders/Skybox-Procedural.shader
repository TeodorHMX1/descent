...
Shader "Skybox/Procedural"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            static const float3 kInvWavelength = float3(1.0 / (WR * WR * WR * WR), 1.0 / (WG * WG * WG * WG),
                                                        1.0 / (WB * WB * WB * WB));
            ...
            v2f vert(appdata_t v)
            {
                ...
                if (eyeRay.y >= 0.0)
                {
                    ...
                    far = sqrt(kOuterRadius2 + kInnerRadius2 * eyeRay.y * eyeRay.y - kInnerRadius2) - kInnerRadius *
                        eyeRay.y;
