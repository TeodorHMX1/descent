...
Shader "Shader Forge/Destructible Mobile"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float3 node_7351_nrm_detail = float3(
                    lerp(_DetailNormal_var.rgb, float3(node_9328, node_9328, node_9328), node_4699).rg,
                    node_6250) * float3(-1, -1, 1);
                float3 node_7351_nrm_combined = node_7351_nrm_base * dot(node_7351_nrm_base, node_7351_nrm_detail) /
                    node_7351_nrm_base.z - node_7351_nrm_detail;
